...
GO
CREATE FUNCTION Sales.uf_getProductss(@SalesOrderID int, @CurrencyCode nchar(3) ,@CurrencyRateDate datetime)
	RETURNS TABLE 
AS
	RETURN
	WITH Products
...
GO
--SELECT * FROM Sales.uf_getProduct(43659, 'CNY', '2011-06-01 00:00:00.000');